...
<script>
    function addHyphen(input) {
      ...
      let hyphened = value.replace(/\D/g, '').match(/.{1,4}/g).join('-');
      input.value = hyphened;
    }
  </script>
	<div class="container">
		<br>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Payment</li>
  </ol>
</nav>
</div>
<hr>
				...
				<sf:form method="post"
					...
					<div class="col-md-12">
						<label for="inputEmail4" class="form-label">Card No</label>
						 <input type="text" name="cardNo" oninput="addHyphen(this)" maxlength="19" placeholder="Enter Card No" class="form-control" id="inputEmail4"
					...
					<div class="col-md-12">
						<label for="inputEmail4" class="form-label">CVV</label>
						 <input type="text" name="cvv" placeholder="Enter CVV" maxlength="3" class="form-control" id="inputEmail4"
						 value="" required="required">
					</div>
					<br>
      ...
      <div class="accordion-body"><div class="card">
			...
			<div class="card-body">
				...
				<sf:form method="post"
					...
					<div class="col-md-12">
						<label for="inputEmail4" class="form-label">Cash On Delivery</label>
						<div class="col-12">
						<input type="submit" name="operation"
									value="PlaceOrder"
									class="btn btn-primary btn btn-info" />
